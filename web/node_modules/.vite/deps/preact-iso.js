...
// node_modules/.pnpm/preact-iso@2.8.1_preact-render-to-string@6.5.11_preact@10.25.0__preact@10.25.0/node_modules/preact-iso/src/router.js
var push;
var scope;
...
function Router(props) {
  ...
  H(props.children).some((vnode) => {
    ...
    if (matches) return pathRoute = D(vnode, matchProps);
    if (vnode.props.default) defaultRoute = D(vnode, matchProps);
  });
...
// node_modules/.pnpm/preact-iso@2.8.1_preact-render-to-string@6.5.11_preact@10.25.0__preact@10.25.0/node_modules/preact-iso/src/lazy.js
function lazy(load) {
  let p2, c;
  ...
  const LazyComponent = (props) => {
    ...
    if (!r.current) r.current = p2.then(() => update(1));
    throw p2;
  };
...
// node_modules/.pnpm/preact-iso@2.8.1_preact-render-to-string@6.5.11_preact@10.25.0__preact@10.25.0/node_modules/preact-iso/src/hydrate.js
var initialized;
...
// node_modules/.pnpm/preact-iso@2.8.1_preact-render-to-string@6.5.11_preact@10.25.0__preact@10.25.0/node_modules/preact-iso/src/index.js
function prerender(vnode, options) {
  return import("./prerender-EJY7DGCU.js").then((m) => m.default(vnode, options));
}
export {
  ErrorBoundary,
  LocationProvider,
